...
lambel_nome = tk.Label(janela, text='Nome')
lambel_nome.grid(row=0,column=0, padx=10, pady=10)
entry_nome = tk.Entry(janela)
entry_nome.grid(row=0,column=1, padx=10, pady=10)

lambel_email = tk.Label(janela, text='Email')
lambel_email.grid(row=1,column=0, padx=10, pady=10)
entry_email = tk.Entry(janela)
entry_email.grid(row=1,column=1, padx=10, pady=10)

lambel_cpf = tk.Label(janela, text='Cpf')
lambel_cpf.grid(row=2,column=0, padx=10, pady=10)
...
btn_deletar = tk.Button(janela,text='Delete',command= delete_usuario)
